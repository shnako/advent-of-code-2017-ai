...
fn flood_fill(grid: &Vec<Vec<bool>>, visited: &mut Vec<Vec<bool>>, row: usize, col: usize) {
...
mod tests {
    ...
    fn test_part1_input() {
        let input =
            input::read_input("src/solutions/day14/input.txt").expect("Failed to read input file");
